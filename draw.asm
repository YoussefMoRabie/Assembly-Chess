...
;----------Status Bar Data-----------------------
     ...
     BPwenDie db "B Pwan Die$"
     WPwenDie db "W Pwan Die$"
     BKnightDie db "B Knight Die$"
     WKnightDie db "W Knight Die$"
     BRooKDie db "B Rook Die$"
     WRookDie db "W Rook Die$"
     BQueenDie db "B Queen Die$"
     WQueenDie db "W Queen Die$"
     BBishopDie db "B Bishop Die$"
     WBishopDie db "W Bishop Die$"
     delete__ db "               $"
