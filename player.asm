...
public draw_selector1, draw_selector2 
public s1_row, s1_col, s2_row, s2_col, player_mode

.DATA 
player_mode db 0    ;both_players:0 player1:1 player2:2
s1_row dw 7
s1_col dw 4
...
player_movement proc
    ...
    jmp no_key_pressed ;the key pressed doesn't concern players
